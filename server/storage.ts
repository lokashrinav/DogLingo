  ...
  private async seedData() {
    try {
      ...
      const comprehensiveExercises = [
        // LESSON 001: First Words: "Sit" - 5 exercises
        {
          id: "exercise-001-001",
          lessonId: "lesson-001",
          type: "audio",
          question: "Listen to the correct pronunciation of 'SIT' command. Practice saying it with authority.",
          options: [
            { id: "correct", text: "Play correct pronunciation", description: "Clear, firm 'SIT'" },
            { id: "too-soft", text: "Too gentle", description: "Weak, questioning tone" },
            { id: "too-harsh", text: "Too aggressive", description: "Shouting, scary tone" }
          ],
          correctAnswer: "correct",
          explanation: "Use a clear, confident tone that's firm but not aggressive. Dogs respond best to consistent, authoritative commands.",
          audioUrl: "/audio/commands/sit-correct.mp3",
          imageUrl: null,
          order: 1,
        },
        {
          ...
          question: "What tone should you use when saying 'SIT'?",
          options: [
            { id: "firm", text: "Firm and confident", description: "Clear authority without aggression" },
            { id: "questioning", text: "Questioning and uncertain", description: "Sounds like you're asking permission" },
            { id: "shouting", text: "Loud and intimidating", description: "Could scare or stress the dog" },
            { id: "whisper", text: "Soft whisper", description: "Dog may not hear or take seriously" }
          ],
          correctAnswer: "firm",
          explanation: "A firm, confident tone establishes clear leadership while maintaining a positive training environment.",
          audioUrl: "/audio/explanations/sit-tone.mp3",
          imageUrl: null,
          order: 2,
        },
        {
      ...
      const comprehensiveAchievements = [
        ...
        // MASTER LEVEL ACHIEVEMENTS
        {
          ...
          title: "Grand Master Trainer",
          description: "Completed ALL DogLingo lessons",
          icon: "fas fa-trophy",
          type: "completion",
          requirement: 45,
          xpReward: 2000,
